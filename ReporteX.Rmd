...
Para evaluar si los tratamientos tenían efecto sobre la agudeza visual se realizó una regresión logística ajustada a las principales variables relacionadas con la AMD. No se encontraron en el efecto que del grupo de tratamiento, ni el grosor promedio de la cornea cuando estas variables fueron ajustadas al sexo y edad. Ver tabla  \@ref(tab:Tab1).  
